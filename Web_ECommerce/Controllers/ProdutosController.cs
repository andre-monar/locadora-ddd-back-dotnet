...
namespace Web_ECommerce.Controllers
{
    ...
    {
        public readonly UserManager<Cliente> _userManager;
        ...
        public ProdutosController(InterfaceProductApp InterfaceProductApp, UserManager<Cliente> userManager, InterfaceCompraUsuarioApp InterfaceCompraUsuarioApp, IWebHostEnvironment environment)
        {
        ...
        public async Task<IActionResult> Create(Carro produto)
        {
            try
            {
                var idUsuario = await RetornarIdUsuarioLogado();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Carro produto)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Delete(int id, Carro produto)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> RemoverCarrinho(int id, Carro produto)
        {
            try
            {
        ...
        public async Task SalvarImagemProduto(Carro produtoTela)
        {
            try
            {
